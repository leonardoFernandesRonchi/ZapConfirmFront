      ...
      <div className="flex items-center justify-between">
        ...
        <div className="mt-3 flex mx-auto items-center min-h-[15%] min-w-[90%] max-w-[90%] bg-white rounded-2xl border-2 border-[#E2E8F0]">
          <div className="w-[90%] flex justify-center items-center">
            <input className="w-[90%] min-w[80%] max-w[80%] border-2 border-[#E2E8F0] min-w-[50%] py-2 px-8 rounded-md" type="text" id="name" name="name" placeholder="Buscar por nome, telefone ou e-mail"/>
          </div>
        </div>
